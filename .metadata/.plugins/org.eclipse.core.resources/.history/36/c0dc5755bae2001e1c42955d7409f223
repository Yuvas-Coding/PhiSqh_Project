 ...
 */
@Entity
@Table(name = "T_PENALTY_VERI_WITHOUT_LPO_VW")
@JsonIgnoreProperties(ignoreUnknown=true)
public class TrxNumberVWForVerification implements java.io.Serializable {
	...
	public TrxNumberVWForVerification() {
	}


	@Column(name = "P_INCIDENCE_CODE")

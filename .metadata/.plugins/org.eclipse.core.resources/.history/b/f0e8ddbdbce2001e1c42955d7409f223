...
// default package
// Generated Mar 29, 2013 3:59:18 PM by Hibernate Tools 3.4.0.CR1
...
/**
 * TNotificationFacility generated by hbm2java
 */
@Entity
@Table(name = "T_NOTIFICATION_FACILITY")
@JsonIgnoreProperties(ignoreUnknown=true)
public class NotificationFacility implements java.io.Serializable {
	...
	private NotificationHdr notificationHdr;
	private Long notificationHdrSeqno;

	public NotificationFacility() {
	}

	public NotificationFacility(long nfSeqno) {
		super();
	...
	@JsonBackReference
	public NotificationHdr getNotificationHdr() {
		return this.notificationHdr;
	}

	public void setNotificationHdr(NotificationHdr notificationHdr) {

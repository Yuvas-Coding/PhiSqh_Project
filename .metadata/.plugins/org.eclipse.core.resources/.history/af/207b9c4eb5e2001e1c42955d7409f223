 ...
 */
@Entity
@Table(name = "t_indent_hdrs_int")
@XmlRootElement(name = "IndentHdrsInt")
@JsonIgnoreProperties(ignoreUnknown=true)
public class IndentHdrsInt implements Serializable {
	...
	private List<IndentDtlsInt> indentDtlsInts = new ArrayList<IndentDtlsInt>();
	...
	private String indenterCreatedBy;
	
	public IndentHdrsInt() {
	}
	...
	public List<IndentDtlsInt> getIndentDtlsInts() {
		return this.indentDtlsInts;
	}

	public void setIndentDtlsInts(List<IndentDtlsInt> indentDtlsInts) {
	...
	@Column(name = "indenter_createdby")
	public String getIndenterCreatedBy() {
		return indenterCreatedBy;
	}

	public void setIndenterCreatedBy(String indenterCreatedBy) {
		this.indenterCreatedBy = indenterCreatedBy;
	}
}
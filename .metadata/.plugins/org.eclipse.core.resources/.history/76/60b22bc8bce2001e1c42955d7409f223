...
/**
 * TNotificationDtls generated by hbm2java
 */
@Entity
@Table(name = "T_NOTIFICATION_DTLS")
@XmlRootElement(name="NotificationDtl")
@JsonIgnoreProperties(ignoreUnknown=true)
public class NotificationDtl implements java.io.Serializable {
	...
	public NotificationDtl() {
	}
	
	public NotificationDtl(long dtlSeqNo) {

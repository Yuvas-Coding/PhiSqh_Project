 ...
 */
@Entity
@Table(name = "t_rejectissue_hdrs_int")
@XmlRootElement(name = "RejectIssueHdrsInt")
public class RejectIssueHdrsInt implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long rimhIntSeqno;
	...
	private Set<RejectIssueDtlsInt> rejectIssueDtlsInts = new HashSet<RejectIssueDtlsInt>(0);
	...
	public RejectIssueHdrsInt() {
	}

	@Id
	@SequenceGenerator(name = "PH_REJECT_ISSUE_HDRS_INT_IMHINTSEQNO_GENERATOR", sequenceName = "T_REJECTISSUE_HDRS_INT_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PH_REJECT_ISSUE_HDRS_INT_IMHINTSEQNO_GENERATOR")
	@Column(name = "rimh_int_seqno")
	public Long getRimhIntSeqno() {
		return this.rimhIntSeqno;
	}

	public void setRimhIntSeqno(Long rimhIntSeqno) {
		this.rimhIntSeqno = rimhIntSeqno;
	}
	...
	// bi-directional many-to-one association to RejectIssueDtlsInt
	@OneToMany(mappedBy = "rejectIssueHdrsInt")
	@XmlElement
	@JsonManagedReference
	public Set<RejectIssueDtlsInt> getRejectIssueDtlsInts() {
		return this.rejectIssueDtlsInts;
	}

	public void setRejectIssueDtlsInts(Set<RejectIssueDtlsInt> rejectIssueDtlsInts) {
		this.rejectIssueDtlsInts = rejectIssueDtlsInts;
	}

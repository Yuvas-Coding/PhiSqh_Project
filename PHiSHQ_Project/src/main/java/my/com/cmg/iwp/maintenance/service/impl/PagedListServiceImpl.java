...
import my.com.cmg.iwp.maintenance.service.PagedListService;
...
public class PagedListServiceImpl implements PagedListService, Serializable {
	...
	public void setHibernateSearchSupport(
			HibernateSearchSupport hibernateSearchSupport) {
		this.hibernateSearchSupport = hibernateSearchSupport;
	}

	@SuppressWarnings("unused")
	private <T> void initSearchObject(HibernateSearchObject<T> so, int start,
			int pageSize) {

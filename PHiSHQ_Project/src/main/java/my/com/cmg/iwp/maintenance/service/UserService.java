...
public interface UserService {
	...
	SecUser getUserByNameAndPassword(String userName, String userPassword);

	SecUser getUserByFiluserNr(String usr_nr);

	SecUser getUserByID(Long usr_id);

	Language getLanguageById(int lan_id);

	boolean isFacilityUser(SecUser secUser);

	List<SecUser> getUserDetailByEmail(String usrEmail);

	void createUserRoleManageProfile(SecUser secUser, SecUserrole secUserRole);

	List<SecRole> getRolesByUserForSdr(SecUser aUser, List<String> listSdrRole);

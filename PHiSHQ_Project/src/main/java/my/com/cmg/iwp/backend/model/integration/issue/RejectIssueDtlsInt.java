 ...
 */
@Entity
@Table(name = "t_rejectissue_dtls_int")
@XmlRootElement(name = "RejectIssueDtlsInt")
public class RejectIssueDtlsInt implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long rimdIntSeqno;
	...
	private RejectIssueHdrsInt rejectIssueHdrsInt;
	private String batchNo;

	public RejectIssueDtlsInt() {
	}

	@Id
	@SequenceGenerator(name = "PH_REJECT_ISSUE_DTLS_INT_IMDINTSEQNO_GENERATOR", sequenceName = "T_REJECTISSUE_DTLS_INT_SEQ", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PH_REJECT_ISSUE_DTLS_INT_IMDINTSEQNO_GENERATOR")
	@Column(name = "rimd_int_seqno")
	public Long getRimdIntSeqno() {
		return this.rimdIntSeqno;
	}

	public void setRimdIntSeqno(Long rimdIntSeqno) {
		this.rimdIntSeqno = rimdIntSeqno;
	}
	...
	/*
	 * @Column(name="brand_code") public String getBrandCode() { return
	 * this.brandCode; }
	 * 
	...
	// bi-directional many-to-one association to RejectIssueHdrsInt
	@ManyToOne
	@JoinColumn(name = "rimh_int_seqno")
	@JsonBackReference
	public RejectIssueHdrsInt getRejectIssueHdrsInt() {
		return this.rejectIssueHdrsInt;
	}

	public void setRejectIssueHdrsInt(RejectIssueHdrsInt rejectIssueHdrsInt) {
		this.rejectIssueHdrsInt = rejectIssueHdrsInt;
	}
